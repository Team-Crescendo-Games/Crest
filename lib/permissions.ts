...
export const ALL_PERMISSIONS = Object.values(Permission).reduce((acc, val) => acc | val, 0);

/** Default member permissions: create + edit content. */
export const DEFAULT_MEMBER_PERMISSIONS = Permission.CREATE_CONTENT | Permission.EDIT_CONTENT;
