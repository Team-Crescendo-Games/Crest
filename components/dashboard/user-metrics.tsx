    ...
    <div className="space-y-6">
      ...
      <div className="rounded-md border border-border bg-bg-elevated/60 p-4 backdrop-blur-sm">
        <div className="mb-4 flex items-center justify-between">
          <div>
            <h3 className="font-mono text-xs font-medium text-fg-primary">Completed Points</h3>
            <p className="mt-0.5 text-[11px] text-fg-muted">Task points completed per week</p>
          </div>
      ...
      <div className="rounded-md border border-border bg-bg-elevated/60 p-4 backdrop-blur-sm">
        <div className="mb-4">
          <h3 className="font-mono text-xs font-medium text-fg-primary">Tasks by Tag</h3>
          <p className="mt-0.5 text-[11px] text-fg-muted">Distribution of tags across all assigned tasks</p>
        </div>

        {tagData.length === 0 ? (
          <div className="flex h-[120px] items-center justify-center">
            <p className="text-[11px] text-fg-muted">No tagged tasks found.</p>
          </div>
        ) : (
            ...
            <div className="flex flex-wrap gap-x-4 gap-y-1.5 sm:flex-col sm:gap-y-2">
              {tagData.map((tag) => (
                <div key={tag.name} className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-[11px] text-fg-secondary">{tag.name}</span>
