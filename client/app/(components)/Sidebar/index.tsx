...
const Sidebar = () => {
    ...
    const sidebarClassNames = `fixed flex flex-column h-[100%] justify-between shadow-xl
    ...
    return <div className={sidebarClassNames}>
        <div className="flex h-full w-full flex-col justify-start">
            ...
            <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
                <Image src="/logo.png" width={40} height={40} alt="EDLIST Logo"></Image>
                <div>
    ...
    return (
        <Link href={href} className="w-full">
            ...
            className={
                ...
                {isActive && (
                    <div className="absolute left-0 top-0 h-full w-1.25 bg-blue-200"></div>
                )}
