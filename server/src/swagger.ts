      ...
      schemas: {
        ...
        Task: {
          ...
          properties: {
            ...
            title: { type: "string" },
            description: { type: "string", nullable: true },
            status: { type: "integer", description: "0=Input Queue, 1=Work In Progress, 2=Review, 3=Done" },
            priority: { type: "string", enum: ["Urgent", "High", "Medium", "Low", "Backlog"] },
        ...
        Notification: {
          ...
          properties: {
            id: { type: "integer" },
            userId: { type: "integer" },
            type: { type: "integer", description: "0=Mention, 1=NearOverdue, 2=Overdue, 3=TaskEdited, 4=TaskReassigned" },
